...
class App extends React.Component {
  ...
  async lookupskillsforoccupation(id){
    var requeststr = this.state.searchendpoint + '/occupations/' + id + '/skills?10'
    ...
    if(mode === 'full' && type === 'occupations'){
      ...
      <div>
        <Table celled striped compact>
          <Table.Header>
            <Table.Row>
              <Table.HeaderCell colSpan='3'><Header as='h4'>Top roles suitable for career change or progression</Header></Table.HeaderCell>
            </Table.Row>
          </Table.Header>
          <Table.Body>
